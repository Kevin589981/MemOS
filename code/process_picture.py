...
LOCAL_IMAGE_SERVER = "http://101.94.138.184:5000"  # 本地图片服务地址
        ...
        messages = [
            {
                ...
                "content": [
                    ...
                    {
                        "type": "text", 
                        "text": """Please provide a detailed description of the content of this image.
Focus on:
Text in the image (such as book titles, headlines, slogans, etc.)
Main objects and scenes
People (if any)
Colors and atmosphere
Any special symbols or logos
Please use complete sentences for the description and include all visible important information."""
                    },
                ],
            },
        ]
