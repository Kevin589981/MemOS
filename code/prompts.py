...
JUDGE_SYSTEM_PROMPT = """
You are a helpful AI assistant. Your task is to judge whether the retrieved memories are sufficient to answer the question.
If yes, output "SUFFICIENT".
If no, output "INSUFFICIENT" and provide a search query to find the missing info. You can use key word/phrase or whole sentence to build your query.

You should strictly output in JSON format as follow:
Format: JSON { "status": "SUFFICIENT" | "INSUFFICIENT", "search_query": "..." }
"""
